...
public class Maxflow {
	public class Node {
		...
		public int pEdge;
		public int pNode;
		public Vector<Integer> fors = new Vector<Integer>();
		public Vector<Integer> backs = new Vector<Integer>();
		public Node(int i) {
			this.label = i;
		}
	}
	...
	public class Edge {
		...
		public int capacity;
		public int flow;
		public int direct; //1 forward 2 back
		public Edge(int i) {
			this.label = i;
		}
	}
	...
	private void inputCapacity() throws IOException {
		...
		while ((line = br.readLine()) != null) {
			...
			if (i >= e.length) {
				System.out
						.println("# of lines is greater than # of edges in G, exit...");
				System.exit(1);
			}
