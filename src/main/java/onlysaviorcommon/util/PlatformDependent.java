...
import onlysaviorcommon.util.chmv8.ConcurrentHashMapV8;
...
/**
 * Created by onlysavior on 14-6-24.
 */
public class PlatformDependent {
    private static final Logger logger = Logger.getLogger(PlatformDependent.class);
    ...
    /**
     * Creates a new fastest {@link java.util.concurrent.ConcurrentMap} implementaion for the current platform.
     */
    ...
    /**
     * Create a new optimized {@link java.util.concurrent.atomic.AtomicReferenceFieldUpdater} or {@code null} if it
     * could not be created. Because of this the caller need to check for {@code null} and if {@code null} is returned
     * use {@link java.util.concurrent.atomic.AtomicReferenceFieldUpdater#newUpdater(Class, Class, String)} as fallback.
     */
    ...
    /**
     * Create a new optimized {@link java.util.concurrent.atomic.AtomicIntegerFieldUpdater} or {@code null} if it
     * could not be created. Because of this the caller need to check for {@code null} and if {@code null} is returned
     * use {@link java.util.concurrent.atomic.AtomicIntegerFieldUpdater#newUpdater(Class, String)} as fallback.
     */
    ...
    /**
     * Create a new optimized {@link java.util.concurrent.atomic.AtomicLongFieldUpdater} or {@code null} if it
     * could not be created. Because of this the caller need to check for {@code null} and if {@code null} is returned
     * use {@link java.util.concurrent.atomic.AtomicLongFieldUpdater#newUpdater(Class, String)} as fallback.
     */
    ...
    /**
     * Create a new {@link java.util.Queue} which is safe to use for multiple producers (different threads) and a single
     * consumer (one thread!).
     */
