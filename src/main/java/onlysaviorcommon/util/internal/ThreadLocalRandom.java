...
public final class ThreadLocalRandom extends Random {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.internal.ThreadLocalRandom.class);
    ...
    public static long getInitialSeedUniquifier() {
        ...
        synchronized (io.netty.util.internal.ThreadLocalRandom.class) {
